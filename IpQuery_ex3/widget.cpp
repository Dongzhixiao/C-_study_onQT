    ...
    : QWidget(parent), m_ipQuery(this)
{
    ...
    QGridLayout *layout = new QGridLayout(this);  //管理IP地址编辑框、“查询”按钮、显示结果的QLabel
    layout->setColumnStretch(1, 1);    //设置行伸缩系数
    ...
    layout->setRowStretch(3, 1);     //设置列伸缩系数
}
